    ...
    <nav class="navbar is-white" role="navigation" aria-label="main navigation">
      ...
      <div class="navbar-menu" id="navMenu" v-bind:class="{ 'is-active': menuActive }">
        <div class="navbar-end">
          ...
          <nuxt-link to="/ranking/2020q4" class="navbar-item">2020Q4</nuxt-link>
      </div>
    </div>
    </nav>
    <div class="clcontent">
...
const quarterResults: { [key: string]: DayResult[] } = {
  "2020q4": [
    new DayResult("11/14 (土)", [
      new Result("北口 善紀", 320),
      new Result("清水 明彦", 124),
      new Result("竹澤 亮", -17),
      new Result("網 亮太朗", -387)
    ]),
    new DayResult("11/13 (金)", [
      new Result("祖父江 尚也", 99),
      new Result("島田 昴祐", 64),
      new Result("清水 明彦", 57),
      new Result("石橋 享典", 33),
      new Result("竹澤 亮", -3.5),
    ...
    new DayResult("11/6 (金)", [
      new Result("竹澤 亮", 205),
      new Result("網 亮太朗", 72),
      new Result("北口 善紀", 36.5),
      new Result("清水 明彦", -111),
      new Result("石橋 享典", -152.5),
    ]),
    new DayResult("10/23 (金)", [
      new Result("石橋 享典", 174),
      new Result("網 亮太朗", 4.5),
      new Result("足立 真陽", -5),
      new Result("島田 昴祐", -133.5)
    ]),
    new DayResult("10/17 (土)", [
      new Result("竹澤 亮", 199.5),
      new Result("清水 明彦", 58.5),
      new Result("網 亮太朗", -32),
      new Result("稲田 翼", -186)
    ]),
    new DayResult("10/9 (金)", [
      new Result("金子 侑起", 82),
      new Result("稲田 翼", 54),
      new Result("足立 真陽", 37),
      new Result("北口 善紀", -133)
    ]),
  ],
  "2020q3": [
    ...
    new DayResult("9/22 (火)", [
      new Result("竹澤 亮", 216),
      new Result("北口 善紀", 1),
      new Result("足立 真陽", -5),
      new Result("清水 明彦", -172)
    ]),
    new DayResult("9/12 (土)", [
      new Result("足立 真陽", 164),
      new Result("金子 侑起", 116),
      new Result("石橋 享典", 32),
      new Result("稲田 翼", -63),
      new Result("祖父江 尚也", -199)
    ]),
    new DayResult("9/4 (金)", [
      new Result("足立 真陽", 196),
      new Result("島田 昴祐", 186),
      new Result("北口 善紀", 68),
      new Result("竹澤 亮", 51.5),
      new Result("清水 明彦", 47),
      new Result("稲田 翼", 1.5),
      new Result("網 亮太朗", -18.5),
      new Result("石橋 享典", -83.5),
      new Result("祖父江 尚也", -88),
      new Result("金子 侑起", -91.5),
      new Result("清水 貴大", -158.5)
    ]),
    new DayResult("8/29 (土)", [
      new Result("足立 真陽", 107.5),
      new Result("北口 善紀", 74.5),
      new Result("網 亮太朗", 68.5),
      new Result("石橋 享典", 25),
      new Result("祖父江 尚也", -12.5),
      new Result("清水 明彦", -73.5),
      new Result("稲田 翼", -119.5)
    ]),
    new DayResult("8/28 (金)", [
      new Result("網 亮太朗", 126.5),
      new Result("石橋 享典", 33.5),
      new Result("北口 善紀", 22),
      new Result("清水 明彦", -142)
    ]),
    new DayResult("8/14 (金)", [
      new Result("竹澤 亮", 78.5),
      new Result("北口 善紀", 66),
      new Result("金子 侑起", 61.5),
      new Result("石橋 享典", 34),
      new Result("網 亮太朗", -29),
      new Result("祖父江 尚也", -65),
      new Result("稲田 翼", -76)
    ]),
    new DayResult("8/10 (月)", [
      new Result("石橋 享典", 103),
      new Result("北口 善紀", 80),
      new Result("清水 明彦", 70.5),
      new Result("稲田 翼", 56),
      new Result("足立 真陽", 22.5),
      new Result("祖父江 尚也", -29.5),
      new Result("清水 貴大", -93),
      new Result("網 亮太朗", -129.5)
    ]),
    new DayResult("8/8 (土)", [
      new Result("石橋 享典", 215.5),
      new Result("祖父江 尚也", 128.5),
      new Result("稲田 翼", 2.5),
      new Result("清水 明彦", -17.5),
      new Result("北口 善紀", -35),
      new Result("足立 真陽", -93),
      new Result("竹澤 亮", -131)
    ]),
